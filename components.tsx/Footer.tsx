      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-8 mb-6 md:mb-0">
          ...
          <div className="flex space-x-4">
            {/* WhatsApp */}
            <Link 
              href="https://api.whatsapp.com/send/?phone=916295616967&text&type=phone_number&app_absent=0"
              target="_blank"
            ...
            {/* Instagram */}
            <Link 
              href="https://www.instagram.com/preetizen_/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-white rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors duration-300"
            >
            ...
            {/* Facebook */}
            <Link 
              href="https://www.facebook.com/Preetizen.fashion/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-white rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors duration-300"
            >
        ...
        <div className="flex flex-col md:text-right space-y-2 text-sm">
          <Link 
            href="/privacy-policy" 
